...
impl ApiBuilder {
    ...
    pub fn from_cache(cache: Cache) -> Self {
        ...
        Self {
            endpoint: std::env::var("HF_ENDPOINT").unwrap_or("https://huggingface.co".to_string()),
...
impl ApiRepo {
    ...
    /// assert_eq!(url, std::env::var("HF_ENDPOINT").unwrap_or("https://huggingface.co".to_string()) + "/gpt2/resolve/main/model.safetensors");
    /// ```
